...
class JPEGCompress(object):
    ...
    def dct_and_quant(self, img_path):
        ...
        for i in range(3):
            ...
            if DEBUG and not i:
                print("The original block:")
                print(img_blocks[0][0], end='\n\n')
                print("The dct blocks:")
                print(dct_blocks[0][0], end='\n\n')
                print("The quant blocks:")
                print(quant_blocks[0][0][0], end='\n\n')
        return quant_blocks
    ...
    def stegano(self, img_path, three_quant_blocks):
        ...
        for dim in range(3):
            ...
            try:
                ...
                pass
        if DEBUG:
            print("The original secret img:")
            print(bin_seqs[0])
            print(bin_seqs[1])
            print(bin_seqs[2], end='\n\n')

            print(list(bin_seqs[0][:20]), end='\n\n')
            print("The stegano block:")
            print(three_quant_blocks[0][0][0], end='\n\n')
    ...
    def reverse_process(self, stegano_blocks):
        ...
        for i in range(3):
            ...
            if DEBUG and not i:
                print("The reversed quant block:")
                print(iquant_blocks[0][0], end='\n\n')
                print("The reversed dct block:")
                print(idct_blocks[0][0], end='\n\n')
    ...
    def decompress_pic(self, codec, compress_pic):
        ...
        if DEBUG:
            print("The decompress block:")
            print(decoded_blocks[0][0][0], end='\n\n')
    ...
    def extrct_info(self, three_decoded_blocks, secret_shape):
        ...
        img_arrs = []
        if DEBUG: print("The extracted img:")
    ...
    def stegano_compress(self, basic_path, secret_path):
        ...
        if DEBUG: print('size of compressed pic is %.2fkB' % (len(encoded) / 1024), end='\n\n')
        return codec, encoded
